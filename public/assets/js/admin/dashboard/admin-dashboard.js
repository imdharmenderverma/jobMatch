$(document).ready(function(e){
    ...
    $("#id_toggle").click(function () {
        $("#type_of_work").selectpicker("toggle");
    });
});
    ...
    var myLineChart = new Chart(lineChart, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                borderWidth: 2,
                data: [1400, 1100, 1300, 800, 1100, 1600, 1300]
            }]
        },
        options: {
            responsive: true,
...
function loadSalary() {
    var typeOfWork = $("#type_of_work").val();
    ...
    $.ajax({
        url: avgSalary + "/" + typeOfWork,
        type: "GET",
        dataType: "json",
        success: function (data) {
            $("#totalsalary").html("$" + data.data.averageSalary);
        },
    });
}
