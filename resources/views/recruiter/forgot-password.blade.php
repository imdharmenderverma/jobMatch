...
.backtologin.form-group a, .backtologin.form-group a:hover {
    color: #228690 !important;
}
    ...
    <div class="container landing wrapper align-items-center d-flex justify-content-center">
        <div class="row align-items-center d-flex justify-content-center mobileFlex">
            ...
            <div class="col-md-4 formWrapper mb-4" style="padding: 20px 20px;">
                <form method="POST" id="forgot-form" action="{{ route('recruiter.save-forgot-password') }}">
                    @csrf
                    ...
                    <div class="forgotpwd form-group backtologin"><a href="{{ route('recruiter.login') }}">Back to login</a></div>
                </form>
            </div>
...
@section('page-js')
<script>
    var emailURL = `{{ route('recruiter.save-forgot-password') }}`;
</script>
<script src="{{ asset('assets/js/admin/recruiter/forgot-password.js') }}"></script>
@endsection